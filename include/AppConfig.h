...
// RSSI 稳定滤波：固定位置下 RSSI 仍会自然抖动，先做低通滤波，再忽略小幅跳动。
// ALPHA_NUM / ALPHA_DEN 越小越稳但响应越慢；DEADBAND 越大越不容易因微小 RSSI 抖动改变节奏。
constexpr uint8_t RSSI_FILTER_ALPHA_NUM = 1;
constexpr uint8_t RSSI_FILTER_ALPHA_DEN = 4;
constexpr int RSSI_FILTER_DEADBAND_DBM = 2;
